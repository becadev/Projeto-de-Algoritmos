...
private:
    ...
    void increase_capacity_() {     // função para aumentar a capacidade a lista
        int* new_array = new int[this->capacity_+1000]; // cria array com capacidade maior do que a atual, dobro do tamanho atual
        ...
        this->data = new_array;
        this->capacity_ += 1000;  // Atualiza a capacidade atual da array   
    }
public:
